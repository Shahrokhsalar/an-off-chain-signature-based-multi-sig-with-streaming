...
contract StreamingMetaMultiSigWallet {
    ...
    function addSigner(address newSigner, uint newSignaturesRequired) public onlySelf{
    ...
    require(validSignatures >= validSignatures, "executeTransaction: not enough valid signatures");
